<script lang="ts">
	...
	import manage from "$lib/assets/subscribe/manage.png";
	import add from "$lib/assets/subscribe/add.png";
	import setUrl from "$lib/assets/subscribe/set-url.png";
	...
	<Stack gap="md">
			...
			<Box background="card">
				<Inset>
					<Cluster>
						...
						<p class="tx-body">This process varies based on which devices or calendar services you use.
							Select your Calendar you use to continue.</p>
					</Cluster>
				</Inset>
			</Box>
		{/if}
		{#if currentTab === 'apple'}
			<div class="prose prose-invert">
				...
				<div class="not-prose">
					<LinkButton type="primary" href="webcal://nucats.org/events.ics" extraClass="lg:w-fit" isExternal>
						Add to Calendar
					</LinkButton>
				</div>
				<h3>Steps</h3>
		...
		{#if currentTab === 'google'}
			<div class="prose prose-invert">
				...
				<div class="not-prose">
					<LinkButton type="primary" href="https://www.google.com/calendar/r?cid=webcal%3A%2F%2Fnucats.org%2Fevents.ics" extraClass="lg:w-fit" isExternal>
						Add to Calendar
					</LinkButton>
				</div>
				<h3>Steps</h3>
		...
		{#if currentTab === 'manual'}
			<div class="prose prose-invert">
				...
				<p>If you do not use Apple or Google's Calendar you will have to manually subscribe to the events calendar.</p>
				<div class="not-prose">
				...
				<ol>
					...
					<li>
						...
						<img src={manage} alt="GNOME Calendar button labeled Manage Calendar"/>
					</li>
					<li>
						...
						<img src={add} alt="GNOME Calendar dialog showing all calendars with an option to Add Calendar"/>
					</li>
					<li>
						Paste the URL copied from this page into the URL input and follow any additional prompts.
						<img src={setUrl} alt="GNOME Calendar new calendar dialog showing where to paste the Calendar URL."/>
					</li>
					<li>You're done, new events should now appear in your calendar app!</li>
				</ol>
			</div>
